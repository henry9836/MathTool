...
float QuaternionCalculator::AbsValue_A()
{
	float AbsValue;
	double r;
	r = sqrt(pow(this->a1, 2) + pow(this->b1, 2) + pow(this->c1, 2) + pow(this->d1, 2));
	AbsValue = static_cast<float>(r);
	return AbsValue;
}
...
float QuaternionCalculator::AbsValue_B()
{
	float AbsValue;
	double r;
	r = sqrt(pow(this->a2, 2) + pow(this->b2, 2) + pow(this->c2, 2) + pow(this->d2, 2));
	AbsValue = static_cast<float>(r);
	return AbsValue;
}
